...
export default function NutritionScanner({ onAnalyze }: Props) {
    ...
    const [nutritionResult, setNutritionResult] = useState<ReturnType<
        typeof calculateNutritionScore
    > | null>(null);
    ...
    function handleAnalyze() {
        ...
        setTimeout(() => {
            // Create mock nutrition data from the scan
            // In production, this would come from your AI/OCR API
            const mockData: UserNutritionData = {
                userId: "user-1",
            ...
            const result = calculateNutritionScore(mockData);
    ...
    return (
        <div className="min-h-screen bg-[#edffde] font-sans relative overflow-hidden">
            ...
            <main className="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-8 py-10 md:py-16 flex flex-col gap-10">
                {/* Header Section */}
