        ...
        <footer className="w-full bg-[#1a3129] border-t border-lime-100">
            ...
            <div className="mx-auto w-full max-w-7xl px-8 py-12 flex flex-col gap-8">
                ...
                <div className="text-center">
                    <h2 className="text-3xl md:text-4xl font-black text-white ">NutriVision</h2>
                </div>
                ...
                <div className="flex justify-center items-center gap-4 md:gap-20 pb-6 border-b border-lime-300 overflow-x-auto">
                    ...
                    <a href="#tentang" className="text-stone-50 text-sm md:text-lg font-regular hover:text-lime-300 transition whitespace-nowrap">
                        Tentang
                    </a>
                    <a href="#scan" className="text-stone-50 text-sm md:text-lg font-regular hover:text-lime-300 transition whitespace-nowrap">
                        Scan
                    </a>
                    <a href="#" className="text-stone-50 text-sm md:text-lg font-regular hover:text-lime-300 transition whitespace-nowrap">
                        Log In
                    </a>
                </div>
                        ...
                        {teamMembers.map((member, index) => (
                            <div key={index} className="flex items-center gap-2 p-2 md:p-3 rounded outline outline-1 outline-[#2C5446] flex-shrink-0">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-zinc-300 text-xs leading-3 md:leading-4 truncate">{member.id}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                    <div className="text-zinc-100 text-xs md:text-sm font-normal whitespace-nowrap flex-shrink-0">
                        @ 2026 NutriVision
                    </div>
                </div>
            </div>
